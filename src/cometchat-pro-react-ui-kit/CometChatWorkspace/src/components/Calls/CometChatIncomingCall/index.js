      ...
      let callType = (
        <React.Fragment>
          <i
            ...
            title={Translator.translate('INCOMING_AUDIO_CALL', this.props.lang)}></i>
        ...
        callType = (
          <React.Fragment>
            <i
              ...
              title={Translator.translate('INCOMING_VIDEO_CALL', this.props.lang)}></i>
        ...
        <div css={incomingCallWrapperStyle(this.props, keyframes)} className="callalert__wrapper">
          <div css={callContainerStyle()} className="callalert__container">
            <div css={headerWrapperStyle()} className="callalert__header">
              ...
              <div css={thumbnailStyle()} className="header__thumbnail hexa">
                <div className="hex1">
                  <div className="hex2">
            ...
            <div css={headerButtonStyle()} className="callalert__buttons" ref={this.callButtonRef}>
              <button
                ...
                onClick={() =>
                  this.rejectCall(this.state.incomingCall, CometChat.CALL_STATUS.REJECTED)
                }>
