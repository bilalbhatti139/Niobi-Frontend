...
import {
  ...
  chatAddStyle,
  chatSearchStyle,
  chatSearchButtonStyle,
  chatSearchInputStyle
} from './style';
...
class CometChatConversationList extends React.Component {
  ...
  searchChat = (e) => {
    ...
    this.ConversationListManager = new ConversationListManager(this.getContext(), val);
    this.ConversationListManager.conversationListenerId()
      .then((response) => {
  ...
  render() {
    ...
    // let chatAddBtn = (
    //   <div css={chatAddStyle(addIcon, theme)}>
    //     <i></i>
    //   </div>
    // );
    let searchChat = (
      <div css={chatSearchStyle()} className="chats__search">
        <button
          type="button"
          className="search__button"
          css={chatSearchButtonStyle(searchIcon, this.getContext())}
        />
        <input
          type="text"
          autoComplete="off"
          css={chatSearchInputStyle(this.props)}
