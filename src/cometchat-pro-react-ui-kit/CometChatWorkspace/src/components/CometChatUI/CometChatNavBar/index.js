          ...
          return (
            <div
              ...
              <div
                ...
                title={Translator.translate('CHATS', this.context.language)}></div>
              <div css={itemLinkTextStyle(chatsTabActive, this.context)} className="item__label">
            ...
            return (
              <div
                ...
                <div
                  ...
                  title={Translator.translate('USERS', this.context.language)}></div>
                <div css={itemLinkTextStyle(userTabActive, this.context)} className="item__label">
                  {Translator.translate('Followers', this.context.language)}
                </div>
              </div>
            );
          }
          ...
          return (
            <div
              ...
              <div
                ...
                title={Translator.translate('GROUPS', this.context.language)}></div>
              <div css={itemLinkTextStyle(groupsTabActive, this.context)} className="item__label">
          ...
          return (
            <div
              ...
              <div
                ...
                title={Translator.translate('MORE', this.context.language)}></div>
              <div css={itemLinkTextStyle(moreTabActive, this.context)} className="item__label">
