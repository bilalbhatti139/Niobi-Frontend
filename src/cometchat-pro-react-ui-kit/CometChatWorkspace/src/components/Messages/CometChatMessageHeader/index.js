    ...
    return (
      <div css={chatHeaderStyle(this.context)} className="chat__header">
        <div css={chatDetailStyle()} className="chat__details">
          ...
          <div css={chatThumbnailStyle()} className="chat__thumbnail hexa">
            <div className="hex1">
              <div className="hex2">
                {avatar}
                {/* {presence} */}
        ...
        <div css={chatOptionWrapStyle()} className="chat__options">
          {role === 'user' ? (
            <>
              {time > start.setHours(14, 0) && time < end.setHours(16, 0) ? (
                <>
                  {videoCallBtn} {audioCallBtn}
                </>
              ) : (
                ''
              )}
          ...
          {/* {hours !== 5
            ...
            : { viewDetailBtn }} */}
          {/* {viewDetailBtn} */}
          {/* {time > start.setHours(15, 28) && time < end.setHours(15, 30) ? (
          (
            "tes  <>
              {videoCallBtn} {audioCallBtn}
            </>
