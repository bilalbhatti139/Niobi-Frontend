  ...
  return (
    <>
      {events
        ...
        .map((person) => (
          <>
            <div className="mt-10 mb-3 grid grid-cols-[0.5fr_5fr_1fr] gap-3 space-x-3 rounded-lg border border-slate-200 bg-white px-6 py-5">
...
export default CanceledSessionsCoach;
