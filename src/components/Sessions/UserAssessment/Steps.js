const Steps = () => {
  return (
    ...
    // <div className="grid grid-cols-12 items-center py-[112px]">
    //   <div className="grid grid-cols-4 col-span-12 sm:col-span-2 sm:col-start-2 md:col-span-2 md:col-start-2 text-center p-2 items-center ">
    //     <div className=" w-8 h-8 text-center items-center rounded-full bg-[#1890FF] border-gray-600 text-white">
    //       1
    //     </div>
    //     <div className=" px-2">
    //       <div className="font-semibold text-[16px]">Introduction</div>
    ...
    //     </div>
    //   </div>
    //   <div className="md:col-span-2 col-span-12 items-center bg-[#1890FF] w-20 h-[2px] rounded-lg xs:h-20 xs:w-[2px]"></div>
    //   <div className="grid grid-cols-4 col-span-12 sm:col-span-2 md:col-span-2 text-center p-2 items-center ">
    //     <div className=" w-8 h-8 text-center items-center rounded-full bg-[#1890FF] border-gray-600 text-white">
    //       2
    //     </div>
    //     <div className=" px-2">
    ...
    //   <div className="md:col-span-2 col-span-12 items-center bg-[#1890FF] w-20 h-[2px] rounded-lg xs:h-20 xs:w-[2px]"></div>
    //   <div className="grid grid-cols-4 col-span-12 sm:col-span-2 md:col-span-2 text-center p-2 items-center ">
    //     <div className="flex justify-center w-8 h-8 text-center items-center rounded-full bg-[#1890FF] border-gray-600 text-white">
    //       3
    //     </div>
    //     <div className=" px-2">
    //       <div className="font-semibold text-[16px]">Result</div>
