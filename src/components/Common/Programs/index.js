            ...
            <div key={post.title} className="shadow-md">
              ...
              <div className="grid grid-cols-3 gap-4 items-center m-3">
                <div className="flex items-center">
                  <span>
                    <img
                      src="/images/dollar-circle-active.png"
                      className="mx-3"
                      alt=""
                      width={14}
                    />
                  ...
                  <span>
                    <img src="/images/book-icon.png" alt="" className="" width={14} />
                  </span>
                </div>
                <div className="flex items-center">
                  <span>
                    <img src="/images/timer.png" alt="" className="mx-2" width={14} />
                  </span>
                  <span>
                    <p className="text-sm font-medium text-gray-500">6 parts</p>
                  </span>
                </div>
                <div className="flex items-center">
                  <span>
                    <img src="/images/profile-2user.png" alt="" className="mx-2" width={14} />
                  </span>
                  <span>
                    <p className="text-sm font-medium text-gray-500">200 enrolled</p>
                  </span>
                </div>
              </div>
              <div className="px-5 ">
