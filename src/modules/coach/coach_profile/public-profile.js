...
import { updateSettingsSuccessStatus } from '../../../redux/reducers/ducks/SettingsDuck';
...
const PublicProfile = (props) => {
  ...
  useEffect(() => {
    setFollowing(followingResponse && followingResponse.is_following);
  }, [followingResponse]);

  useEffect(() => {
    if (publicProfileResponse) {
      console.log(publicProfileResponse, 'RRRRR');
