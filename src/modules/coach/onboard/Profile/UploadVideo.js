...
export default function UploadVideo({sendMessage}) {
  ...
  let vidMsg = videoLink;


  return (
    <>
      <div onClick={() => setShowModal(true)} className="flex justify-center my-6">
        <img
          maxwidth="100%"
          src={`${process.env.PUBLIC_URL}/images/uploadvideo.png`}
          alt="post_image"
        />
      </div>
      {showModal ? (
