...
function UploadProfilePhoto(props) {
  ...
  const onFileUpload = () => {
    ...
    formData.append('dskj', 'selectedImage');
  ...
  return (
    <>
      <div
        ...
        className={
          props.className +
          ' absolute ml-[100px] mt-[-50px] w-[50px] h-[50px] border bg-white border-black-100 flex items-center justify-center rounded-full z-5'
        }>
